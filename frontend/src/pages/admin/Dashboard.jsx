...
const fieldClass =
  "w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-600";
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                {dashboard.activeClasses.length > 4 && (
                  <button
                    ...
                    className="rounded-lg border border-blue-100 bg-blue-50 px-4 py-2 text-sm font-semibold text-blue-700 hover:bg-blue-100"
                  >
                    {showAllClasses
                      ? "View less"
